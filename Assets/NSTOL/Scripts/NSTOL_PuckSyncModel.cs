...
[RealtimeModel]
public partial class NSTOL_PuckSyncModel 
{
...
public partial class NSTOL_PuckSyncModel : IModel {
    // Properties
    ...
    // Events
    public delegate void PositionDidChange(NSTOL_PuckSyncModel model, UnityEngine.Vector3 value);
    public event         PositionDidChange positionDidChange;
    public delegate void RotationDidChange(NSTOL_PuckSyncModel model, UnityEngine.Quaternion value);
