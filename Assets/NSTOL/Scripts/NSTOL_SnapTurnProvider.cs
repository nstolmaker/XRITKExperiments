...
/* 
 * I fully just ripped this from the Unity package so that I can make a tiny change to it.
 */
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    /// </summary>
    public sealed class NSTOL_SnapTurnProvider : LocomotionProvider
    {
        /// <summary>
        ...
        {           
            ...
            // TODO: Reimplement the way the locomotion ownership system works so that it can support locking of player locations/buttons
            // for now, we can just do this by hand, since there's only one instance where we care
            NSTOL_GhostFingerSelect RemoteControl = GameObject.Find("PrototypeRemote").GetComponent<NSTOL_GhostFingerSelect>();
            if (!RemoteControl.beingHeld) { 
